...
latex_documents = [
    (master_doc, 'Uplink.tex', u'Uplink Documentation',
     u'Raj Kumar', 'manual'),
]
...
man_pages = [
    (master_doc, 'uplink', u'Uplink Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Uplink', u'Uplink Documentation',
     author, 'Uplink', 'One line description of project.',
     'Miscellaneous'),
]
